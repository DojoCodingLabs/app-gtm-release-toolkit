...
3. **Where do you want to distribute?** Present options:
   ...
   - DojoCodingLabs Marketplace (startups from hackathons/Launchpad)
...
| DojoCodingLabs Marketplace | `alt-distribution` | Signed APK | PR to startups-android-marketplace |
